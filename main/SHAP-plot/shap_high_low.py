...
# Load the data
file_path = '/home/stefan/Desktop/zjzpa-analiza-main/main/high_low.csv'
data = pd.read_csv(file_path)

# Filter out the 'Highest' values
highest_data = data[data['Substance'].str.contains('Highest')].copy()  # Make a copy to avoid SettingWithCopyWarning
...
output_path = '/home/stefan/Desktop/zjzpa-analiza-main/main/SHAP-plot/heatmap_highest.png'
